...
class AlienFleet:
     ...
     def create_fleet(self):
          ...
          # Use fleet_w = 17, fleet_h = 15 for debugging vvvvvvv  vvvvvvv
     ...
     def calculate_fleet_size(self, alien_w, screen_w, alien_h, screen_h):
         ...
         fleet_h = int(((screen_w/2)//alien_w) + 1)
         fleet_w = int((screen_h//alien_h) - 1)
